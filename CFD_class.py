...
class PipeFlowSimulation:
    def __init__(self, Lx=2.0, Ly=2.0, nx=100, ny=100, rho=1000.0, nu=1.0, g=10.0, dt=1e-5, nt=1000):
    ...
    def pressure_poisson(self, max_iterations=300):
        """
    ...
    def apply_boundary_conditions(self):
        ...
        # # Zero-gradient on the left wall for both u and v
        # self.u[:, 0] = self.u[:, 1]
        # self.v[:, 0] = self.v[:, 1]

        # # Right wall inlet with specified velocity (for rotating flow)
        # self.u[:, -1] = 1.0  # Adjust as needed
        # self.v[:, -1] = 0.5  # Adjust as needed for rotation effect
